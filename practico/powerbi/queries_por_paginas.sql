-- =====================================================
-- QUERIES SQL PARA POWERBI - ORGANIZADAS POR PÁGINAS
-- =====================================================
-- Cada sección corresponde a una página temática en PowerBI
-- Copiar y pegar cada query según la visualización que necesites
-- =====================================================
